...
Version: **0.1.15 reference implementation**
...
- Build-fix/compatibility notes `docs/BUILD_FIX_0.1.1.md` through `docs/BUILD_FIX_0.1.15.md`; separately delivered revision patches provide source-level traceability.
