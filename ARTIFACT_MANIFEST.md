...
Version: **0.1.21 reference implementation**
...
- Build-fix/compatibility notes `docs/BUILD_FIX_0.1.1.md` through `docs/BUILD_FIX_0.1.21.md`; separately delivered revision patches provide source-level traceability.
