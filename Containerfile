...
RUN npm run build \
 ...
 && node scripts/verify-sqlalchemy-reflection.mjs \
 ...
 && node scripts/verify-backend-multiplexing.mjs \
 && node scripts/verify-postgres-alter-table.mjs \
 && node scripts/verify-ibmi-object-stabilization.mjs \
 && node scripts/verify-lob-index-compat.mjs \
